...
const ManipulateAudio = ({ audioUrl }) => {
  ...
  return (
    <div>
      <input type="text" min={0} max={audioDuration} value={trimStart} step={0.1} onChange={handleTrimStartChange} />
      <input type="text" min={0} max={audioDuration} value={trimEnd} step={0.1} onChange={handleTrimEndChange} />
